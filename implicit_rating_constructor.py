...
kgfile=input("Please enter the path of kg file: ")
ratingfile=input("Please enter the path of rating file: ")
new_kg_path=input("Please enter the output path of the kg: ")
new_rating_path=input("Please enter the output path of rating file: ")
